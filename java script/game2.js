...
document.querySelector('#letters').addEventListener('click', clickLetter);
...
function clickLetter(eventArgs) {
  ...
  if ((eventArgs.target.localName === "button") && (notClick == "false")) {
    ...
    checkLetter(eventArgs);
  }
}
//cheking the letter you click now
function checkLetter(eventArgs) {
...
//what happen when you success to guess whole word!(+audio)
